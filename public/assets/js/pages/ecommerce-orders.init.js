...
new gridjs.Grid({
    columns: [
        ...
        },
        {
            name: "Billing Name",
            formatter: function (a) {
                return gridjs.html('<img src="public/assets/images/users/' + a[0] + '" alt="" class="avatar-sm rounded-circle me-2" /><a href="#" class="text-body">' + a[1] + "</a>");
            },
        },
        "Date",
        "Total",
        {
            ...
            formatter: function (a) {
                switch (a) {
                    case "Paid":
                        return gridjs.html('<span class="badge badge-pill badge-soft-success font-size-12">' + a + "</span>");
                    case "Chargeback":
                        return gridjs.html('<span class="badge badge-pill badge-soft-danger font-size-12">' + a + "</span>");
                    case "Refund":
                        return gridjs.html('<span class="badge badge-pill badge-soft-warning font-size-12">' + a + "</span>");
                    default:
                        return gridjs.html('<span class="badge badge-pill badge-soft-success font-size-12">' + a + "</span>");
                }
            },
        },
        {
            ...
            formatter: function (a) {
                switch (a) {
                    case "Mastercard":
                        return gridjs.html('<i class="fab fa-cc-mastercard me-2"></i>' + a);
                    case "Visa":
                        return gridjs.html('<i class="fab fa-cc-visa me-2"></i>' + a);
                    case "Paypal":
                        return gridjs.html('<i class="fab fa-cc-paypal me-2"></i>' + a);
                    case "COD":
                        return gridjs.html('<i class="fas fa-money-bill-alt me-2"></i>' + a);
                }
            },
        },
        {
    ...
    server: {
        ...
        then: data => data.map(movie => [movie.name, [movie.code,movie.code], movie.icon,movie.name,movie.name,movie.name,movie.name]),
